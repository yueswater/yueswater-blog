...
![平面道路速限 50 公里／小時](complexity-analysis/r5-50.svg)
...
![快速道路速限 80 公里／小時](complexity-analysis/r5-80.svg)
...
![國道回堵，電子看板顯示車速降到 40 以下（[Lobester00](https://commons.wikimedia.org/wiki/File:2022-01-30_cars_on_the_Freeway_1_in_middle_west_Taiwan_01.jpg) via Wikimedia Commons, [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)）](complexity-analysis/freeway-congestion.jpg)
...
![國道最低速限 90 公里／小時](complexity-analysis/r6-90.svg)
...
![上限 110](complexity-analysis/r5-110.svg)

![下限 90](complexity-analysis/r6-90.svg)

快速道路也是同樣的例子，只是換一組數字：上限 80、下限 60，里程數一樣會被牢牢夾在 $60n$ 到 $80n$ 之間：

![上限 80](complexity-analysis/r5-80.svg)

![下限 60](complexity-analysis/r6-60.svg)
...
![費氏數列樸素遞迴的呼叫樹，越往下分支越多](complexity-analysis/fib-recursion-tree.svg)
...
![每次遞迴呼叫都在呼叫堆疊上多推一層](complexity-analysis/call-stack.svg)
