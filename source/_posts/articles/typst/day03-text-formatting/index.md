...
date: '2026-08-16'
lang: zh-TW
permalink: articles/typst/day03-text-formatting/
categories: &id001
- Typst
- 排版系統
tags: *id001
...
[上一篇](/articles/typst/day02-getting-started/)寫出了第一份 Typst 文件，練了標題、粗體斜體、清單等幾個最基本的語法。這篇要繼續往下，細談常用的文字排版工具：底線、刪除線、螢光標記這類裝飾語法，上標下標、小型大寫這些細節調整，還有用 `text` 函式客製化字型、字級、顏色與粗細。
