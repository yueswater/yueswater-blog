...
- 桌面應用
tags: *id001
excerpt: AnvilNote 是一款離線優先的寫作與筆記工具，結合簡潔的編輯體驗與 Typst 排版，適合整理長篇筆記、講義、報告與學術文件，並可匯出成 PDF
  或 DOCX。
...
<figure><img src="images/editor-intro-math.png" alt="編輯器畫面"><figcaption>編輯器畫面</figcaption></figure>
...
<figure><img src="images/editor-code-table-chart.png" alt="公式、程式碼與表格"><figcaption>公式、程式碼與表格</figcaption></figure>
...
<figure><img src="images/editor-code-table-chart.png" alt="流程圖與統計圖表"><figcaption>流程圖與統計圖表</figcaption></figure>
