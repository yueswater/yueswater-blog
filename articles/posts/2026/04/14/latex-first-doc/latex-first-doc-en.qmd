...
In the previous article, [Introduction to LaTeX](../../../04/12/latex-intro-en.qmd), we covered how to choose a compiler and editor, along with the basic operations of LaTeX — entering commands, writing comments, opening environments, and setting section depth. In this article, you will learn:
