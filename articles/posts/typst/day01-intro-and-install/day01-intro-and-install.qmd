...
date: 2026-08-14
author: Anthony
categories: [Typst, 排版系統]
description: "從 LaTeX 的痛點出發，認識 Typst 這個以 Rust 打造的新一代排版系統，並完成 macOS / Linux / Windows 安裝與線上編輯器設定。"
image: ../../cover/Typst_logo.png
glossary:
  path: ../../../../_glossary/typst.yml
  popup: hover
alternate-lang: "/articles/posts/typst/day01-intro-and-install/day01-intro-and-install-en.html"
---
...
: {#tbl-comparison tbl-colwidths="[15,25,30,30]"}
