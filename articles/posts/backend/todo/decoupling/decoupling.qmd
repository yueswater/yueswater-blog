...
description: "將程式碼拆分，降低單一檔案的複雜度。"
image: ../../../cover/Backend_logo.png
glossary:
  path: ../../../../../_glossary/backend.yml
  popup: hover
alternate-lang: "/articles/posts/backend/todo/decoupling/decoupling-en.html"
---
...
### 錯誤處理歸屬 {#error-handling-boundary}
