...
description: "Define the data model and connect to the database."
image: ../../../cover/Backend_logo.png
glossary:
  path: ../../../../../_glossary/backend.yml
  popup: hover
alternate-lang: "/articles/posts/backend/todo/models-db/models-db.html"
---
...
## Table Schema Diagram {#table-schema-diagram}
...
#### Set Up the Database {#create-database-py}
...
#### Define the Database {#define-database-py}
...
#### Connect the Database {#connect-database-py}
